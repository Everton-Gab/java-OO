...
**7. Qual é a convenção de nomes para getters e setters em Java?**
...
**2. Se todos fossem `private` sem getters/setters, qual seria o problema?**

R.

**3. Qual é o balanço correto?**

R.

**4. Na sua profissão, por que encapsulamento é importante?**
