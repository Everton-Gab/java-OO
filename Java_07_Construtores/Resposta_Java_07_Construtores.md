...
|-------|--------|----------------|------------------|
| 1 | `new Aluno()` depois `aluno1.nome = ...` | Cria vazio, preenche depois | ? |
| 2 | `new Aluno("Maria", 20)` | Cria já preenchido | ? |
| 3 | `new Aluno()` depois `aluno3.nome = ...` | Cria vazio, preenche depois | ? |
| 4 | `new Aluno("Ana", 21)` | Cria já preenchido | ? |
...
**5. Por que é vantajoso ter um construtor com parâmetros?**
